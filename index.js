...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('ServiceWorker.js?v=0.1.77')
...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/dbe86742b0502cc1cbdf970010cce688.loader.js?v=0.1.77";
var config = {
  dataUrl: buildUrl + "/2e203177562c31e9cec7c68dc1e76fe6.data.unityweb?v=0.1.77",
  frameworkUrl: buildUrl + "/e3dc9ed75ce68d8e73fd6e0dbde82cde.framework.js.unityweb?v=0.1.77",
  codeUrl: buildUrl + "/6ae52a6829de2192edd1463540e6830a.wasm.unityweb?v=0.1.77",
...
canvas.style.background = "url('" + buildUrl + "/bcabcc8a777dfc26c6c98dbdb4fc2755.jpg?v=0.1.77') center / cover";
...
window.addEventListener('load', function ()
{
  ...
  console.log("Game Version: 0.1.77");
