...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('ServiceWorker.js?v=0.1.99')
...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/29e08c257078bf7117e0a28152903d27.loader.js?v=0.1.99";
var config = {
  dataUrl: buildUrl + "/f056920f0e5c8a4b6bac7fc938f0fe06.data.unityweb?v=0.1.99",
  frameworkUrl: buildUrl + "/9fc9a2cd450caebd93b05d06c4174ff8.framework.js.unityweb?v=0.1.99",
  codeUrl: buildUrl + "/3e051c6ab734fd26a9938d13b10a9c63.wasm.unityweb?v=0.1.99",
  streamingAssetsUrl: "StreamingAssets",
  companyName: "d4rk_ltd",
  productName: "MinePixel",
  productVersion: "0.1.99",
...
canvas.style.background = "url('" + buildUrl + "/bcabcc8a777dfc26c6c98dbdb4fc2755.jpg?v=0.1.99') center / cover";
...
window.addEventListener('load', function ()
{
  ...
  console.log("Game Version: 0.1.99");
