...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('ServiceWorker.js?v=0.1.56')
...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/5e2a736e17efd61e22745c30676a7466.loader.js?v=0.1.56";
var config = {
  dataUrl: buildUrl + "/ae0b1a68b753614e3b9384ca64d396ca.data.unityweb?v=0.1.56",
  frameworkUrl: buildUrl + "/0a7578b4db7214bf6375de712302aa05.framework.js.unityweb?v=0.1.56",
  codeUrl: buildUrl + "/4ac3eb9873afd62c68f98e4ded0fce10.wasm.unityweb?v=0.1.56",
  streamingAssetsUrl: "StreamingAssets",
  companyName: "d4rk_ltd",
  productName: "MinePixel",
  productVersion: "0.1.56",
...
canvas.style.background = "url('" + buildUrl + "/bcabcc8a777dfc26c6c98dbdb4fc2755.jpg?v=0.1.56') center / cover";
...
window.addEventListener('load', function ()
{
  ...
  console.log("Game Version: 0.1.56");
