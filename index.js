...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('ServiceWorker.js?v=0.2.49')
...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/036bd4324515dc6c87cbeb6c7d5500bf.loader.js?v=0.2.49";
var config = {
  dataUrl: buildUrl + "/cc597e67a473be39bc2d4bbe0a692a53.data.unityweb?v=0.2.49",
  frameworkUrl: buildUrl + "/5458dc043e6227e879b371e34395a33b.framework.js.unityweb?v=0.2.49",
  codeUrl: buildUrl + "/da4c9341efabb387f0ab4dcb2ad52c46.wasm.unityweb?v=0.2.49",
  streamingAssetsUrl: "StreamingAssets",
  companyName: "d4rk_ltd",
  productName: "MinePixel",
  productVersion: "0.2.49",
...
canvas.style.background = "url('" + buildUrl + "/bcabcc8a777dfc26c6c98dbdb4fc2755.jpg?v=0.2.49') center / cover";
...
window.addEventListener('load', function ()
{
  ...
  console.log("Game Version: 0.2.49");
