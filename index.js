...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('ServiceWorker.js?v=0.3.16')
...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/f79605ff3ae353d519b7cf670f1e5d90.loader.js?v=0.3.16";
var config = {
  dataUrl: buildUrl + "/59e448fdeb86b466a1a40def010e662d.data.unityweb?v=0.3.16",
  frameworkUrl: buildUrl + "/af7abffe9c91232473c1db30d48234b2.framework.js.unityweb?v=0.3.16",
  codeUrl: buildUrl + "/890fd4d68510ab58757cad991b4b4881.wasm.unityweb?v=0.3.16",
...
canvas.style.background = "url('" + buildUrl + "/bcabcc8a777dfc26c6c98dbdb4fc2755.jpg?v=0.3.16') center / cover";
...
window.addEventListener('load', function ()
{
  ...
  console.log("Game Version: 0.3.16");
