...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('ServiceWorker.js?v=0.2.1')
...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/3753992bd3db7e7c83152a0afb455905.loader.js?v=0.2.1";
var config = {
  dataUrl: buildUrl + "/661b3cb331ce484b14cdc52d6238ab2e.data.unityweb?v=0.2.1",
  frameworkUrl: buildUrl + "/9fc9a2cd450caebd93b05d06c4174ff8.framework.js.unityweb?v=0.2.1",
  codeUrl: buildUrl + "/b6305c3a1d4521e6c7d97f75cb7b8a96.wasm.unityweb?v=0.2.1",
...
canvas.style.background = "url('" + buildUrl + "/bcabcc8a777dfc26c6c98dbdb4fc2755.jpg?v=0.2.1') center / cover";
...
window.addEventListener('load', function ()
{
  ...
  console.log("Game Version: 0.2.1");
