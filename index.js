...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('ServiceWorker.js?v=0.2.59')
...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/700cd99c48746c6dfce461f87d9bdf91.loader.js?v=0.2.59";
var config = {
  dataUrl: buildUrl + "/0305c451fd107ec5e6434cb99db5c9ef.data.unityweb?v=0.2.59",
  frameworkUrl: buildUrl + "/f58069a40d7b1cc51b605ad67eb69719.framework.js.unityweb?v=0.2.59",
  codeUrl: buildUrl + "/e2f97c62bce689ac9329a4671c1fd7ca.wasm.unityweb?v=0.2.59",
  streamingAssetsUrl: "StreamingAssets",
  companyName: "d4rk_ltd",
  productName: "MinePixel",
  productVersion: "0.2.59",
...
canvas.style.background = "url('" + buildUrl + "/bcabcc8a777dfc26c6c98dbdb4fc2755.jpg?v=0.2.59') center / cover";
...
window.addEventListener('load', function ()
{
  ...
  console.log("Game Version: 0.2.59");
