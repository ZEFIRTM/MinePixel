...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('ServiceWorker.js?v=0.1.98')
...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/b82948964c1d938811b1afb3cc5af554.loader.js?v=0.1.98";
var config = {
  dataUrl: buildUrl + "/45b4539d45a34b6ef4d12ada67480165.data.unityweb?v=0.1.98",
  frameworkUrl: buildUrl + "/9df2fdac6c15ce6ff4298bced120185b.framework.js.unityweb?v=0.1.98",
  codeUrl: buildUrl + "/d517d415dd528fdde8fbc732c2ada63b.wasm.unityweb?v=0.1.98",
  streamingAssetsUrl: "StreamingAssets",
  companyName: "d4rk_ltd",
  productName: "MinePixel",
  productVersion: "0.1.98",
...
canvas.style.background = "url('" + buildUrl + "/bcabcc8a777dfc26c6c98dbdb4fc2755.jpg?v=0.1.98') center / cover";
...
window.addEventListener('load', function ()
{
  ...
  console.log("Game Version: 0.1.98");
