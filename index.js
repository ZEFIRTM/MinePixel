...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('ServiceWorker.js?v=0.2.60')
...
var buildUrl = "Build";
var loaderUrl = buildUrl + "/1e0590c4f1942dfc9a09ab4dd69568e2.loader.js?v=0.2.60";
var config = {
  dataUrl: buildUrl + "/dbbdcb0fded8e145cd032b0edf6d1111.data.unityweb?v=0.2.60",
  frameworkUrl: buildUrl + "/f58069a40d7b1cc51b605ad67eb69719.framework.js.unityweb?v=0.2.60",
  codeUrl: buildUrl + "/5eef0a9853ea0fbaf95eff25b6e5bd64.wasm.unityweb?v=0.2.60",
  streamingAssetsUrl: "StreamingAssets",
  companyName: "d4rk_ltd",
  productName: "MinePixel",
  productVersion: "0.2.60",
...
canvas.style.background = "url('" + buildUrl + "/bcabcc8a777dfc26c6c98dbdb4fc2755.jpg?v=0.2.60') center / cover";
...
window.addEventListener('load', function ()
{
  ...
  console.log("Game Version: 0.2.60");
